      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            ...
            {{-- form --}}
            <form action="{{ route('presence.in_store') }}" method="post">
              @csrf
              {{-- url --}}
              ...
              <input type="hidden" id="in_location" name="in_location">
...
@push('js')
  ...
  <script>
    ...
    function showPosition(position) {
      ...
      document.getElementById('in_location').value = userLat + ',' + userLng;
